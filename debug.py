# Functions used for debugging the CPU & Video

# Generate a hexdump of the CHIP-8's memory
...
# Generate a bitmap dump of the CHIP-8's video memory
...
# Generate a hexdump of the CHIP-8's registers
...
# Generate a hexdump of the CHIP-8's stack
