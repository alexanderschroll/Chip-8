# CPU and memory of the CHIP-8 Emulator including functions
...
class CHIP8:
    ...
    def __init__(self):
        ...
        # Keyboard pseudo register. indexes 0-15 are used to store the 
    ...
    # Open a ROM file and load it into memory location 0x200
    def file_open(self, file_name):
        try:
            ...
            print("Wrong file name, use syntax: python main.py <ROM Name> <profile>")
